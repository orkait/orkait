			...
			<div className="tablet:hidden flex flex-col gap-14 pt-4 pb-4">
				<div className="flex w-full justify-end">
					<div className="flex w-full max-w-[320px] flex-col items-end gap-8">
						...
						<Button
							asChild
							className="inline-flex px-4 py-2 justify-center items-center gap-[10px] rounded-md bg-foreground text-white hover:bg-slate-900/90 h-auto font-normal text-base"
						>
