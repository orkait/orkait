...
export function ServicesScene() {
    ...
    const updateTimeline = useCallback(({ progress, effectIndex, direction }: LenisTimelineFrame) => {
        const styles = getServicesTimelineStyles(progress);
        ...
        itemRefs.current.forEach((element, index) => {
            ...
            const itemStyles = getServiceItemStyle(progress, index, nextActiveIndex);
